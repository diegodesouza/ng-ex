...
@Component({
  ...
  template: `<div class="collapse-block alert-pattern-v2 limit-one-collapse" [class.ant-block-expanded]="startBlockExpanded">
    <div class="ant-collapse" [ngClass]="{'blue': (color === 'blue'), 'ant-mobile-collapse': (mobileOnly === true)}">
      ...
      <div [ngClass]="{'display-none' : !startBlockExpanded}" class="ant-collapse-body">
          <div>
...
export class CollapseItemCmp implements OnInit, OnChanges {
